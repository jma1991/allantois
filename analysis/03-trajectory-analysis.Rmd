...
knitr::opts_chunk$set(
  autodep    = TRUE,
  cache      = TRUE,
  cache.path = "cache/03-trajectory-analysis.Rmd/",
  cache.lazy = FALSE,
  dev        = "png",
  error      = FALSE,
  message    = FALSE,
...
```{r}
pkg <- c("BiocNeighbors", "EnsDb.Mmusculus.v79", "MouseGastrulationData", "RColorBrewer", "SingleCellExperiment", "cluster", "scater", "scran", "slingshot", "ggbeeswarm", "pheatmap")
...
de1 <- correlateTime(sce, column = "slingPseudotime_1", alpha = 0.05)
...
de2 <- correlateTime(sce, column = "slingPseudotime_2", alpha = 0.05)
...
```{r}
saveRDS(sce, file = "data/03-trajectory-analysis.rds")
```
